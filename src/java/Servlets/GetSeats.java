    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try (PrintWriter out = response.getWriter()) {
            String flightid=request.getParameter("flightid77");
             ...
             boolean flag=db.fgetseats(fid,f);
             if(flag==true)
             {
             ...
             {
                 request.setAttribute("errMessage","cant retrive seats");
               request.getRequestDispatcher("/error.jsp").forward(request, response);
             }
             //---------------------------
             boolean flag2=db.bgetseats(fid,b);
             if(flag2==true)
             {
             ...
             //---------------------------
             boolean flag3=db.egetseats(fid,e);
             if(flag3==true)
             {
             ...
             request.getRequestDispatcher("approveseats.jsp").forward(request, response);
             //---------------------------
             }
