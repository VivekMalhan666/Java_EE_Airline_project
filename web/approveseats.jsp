...
<html>
    ...
    <body><br><br><br><br><br><br><div align="center"><h1 style="color: blue"><b>Approve/Disapprove By Manager</b></h1></div>
     ...
     <form method="post" action="GetSeats" name="f77" onsubmit="return(valid());">
         <br><br><br><br><br>
         <div align="center">
                ...
                <br><br><br>
                <font color="blue">Seats of Firstclass:</font> 
                <input type="number" id="fid88" name="flightid88" value="${fn:escapeXml(firstclass.noOfSeats)}" style="border: 2px solid darkblue; width:80px">
               <br><br><br>
                <font color="blue">Seats of Buisness:</font>
                <input type="number" id="fid888" name="flightid888" value="${fn:escapeXml(buisness.noOfSeats)}" style="border: 2px solid darkblue; width:80px">
                <br><br><br>
                <font color="blue">Seats of Economy:</font>
                <input type="number" id="fid8888" name="flightid8888" value="${fn:escapeXml(economy.noOfSeats)}" style="border: 2px solid darkblue; width:80px">
         </div>
        </form>
        <div align="center">
