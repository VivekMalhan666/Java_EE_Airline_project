...
<html>
    ...
    <body>
     ...
     <br><br><br><br><br><br>
        ...
        <table> 
            <form method="post" action="SetSeats" name="f1" onsubmit="return(valid1());">

            <div align="center"><h1 style="color: blue"><b>Set/Update seats</b></h1></div> <jsp:include page="header.jsp" />
         <div align="center">
  ...
  <div align="center"> <input type="submit" name="single1" class="Button" value="Set" ></div>
         ...
         <div align="center"><h1 style="color: blue"><b>Update seats</b></h1></div>
          <form method="post" action="UpdateSeats" name="f2" onsubmit="return(valid2());">
              <br><br><br><br><br>
         <div align="center">
                <font color="blue">Flight ID</font>
...
<datalist id="typeclass7" style="border-color: blue;">
    ...
    <option value="Economy"/>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <font color="blue">total seats</font>
  ...
  <div align="center"> <input type="submit" name="single2" class="Button" value="Update" ></div>
        ...
        {
            alert("You have not selected no of seats");
            return false;
